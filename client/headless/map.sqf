...
GVAR(deleteClassesConfig) = [
	...
	[M* 15*60, ["Land_Sleeping_bag_folded_F", "Land_CanisterFuel_F", "Land_Mil_WallBig_corner_battered_F", "Land_CanisterOil_F", "Land_Ground_sheet_folded_OPFOR_F", "Land_PaperBox_01_small_closed_brown_F", "Land_Sack_F", "Land_Teapot_EP1"]],
