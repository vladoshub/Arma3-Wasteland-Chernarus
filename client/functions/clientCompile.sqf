...
canForceSaveStaticObject = "client\functions\canForceSaveStaticObject.sqf" call mf_compile;
...
serverSound = "client\functions\serverSound.sqf" call mf_compile;
...
playerClothingGearLevel1 = "client\functions\loadoutClothing\playerGearLevel1.sqf" call mf_compile;
playerClothingGearLevel2 = "client\functions\loadoutClothing\playerGearLevel2.sqf" call mf_compile;
playerClothingGearLevel3 = "client\functions\loadoutClothing\playerGearLevel3.sqf" call mf_compile;
playerClothingGearLevel4 = "client\functions\loadoutClothing\playerGearLevel4.sqf" call mf_compile;
playerClothingGearLevel5 = "client\functions\loadoutClothing\playerGearLevel5.sqf" call mf_compile;
playerClothingGearLevel6 = "client\functions\loadoutClothing\playerGearLevel6.sqf" call mf_compile;
playerClothingGearLevel7 = "client\functions\loadoutClothing\playerGearLevel7.sqf" call mf_compile;
playerClothingGearLevel8 = "client\functions\loadoutClothing\playerGearLevel8.sqf" call mf_compile;
...
playerGearFirst = "client\functions\playerGearFirst.sqf" call mf_compile;
...
spawnOnFlag = "client\functions\spawnOnFlag.sqf" call mf_compile;
spawnOnBeacon = "client\functions\spawnOnBeacon.sqf" call mf_compile;
spawnOnHQ = "client\functions\spawnOnHQ.sqf" call mf_compile;
spawnOnPoint = "client\functions\spawnOnPoint.sqf" call mf_compile;
...
customLoad = "client\systems\customLoad\customLoad.sqf" call mf_compile;
...
populateCustomLoad = "client\systems\customLoad\populateCustomLoad.sqf" call mf_compile;
updateBackpackLoad = "client\systems\customLoad\backpackLoad.sqf" call mf_compile;
addBackpackCustomLoad = "client\systems\customLoad\addBackpack.sqf" call mf_compile;
...
weaponCustomLoad = "client\systems\customLoad\weaponCustomLoad.sqf" call mf_compile;
