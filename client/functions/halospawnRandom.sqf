...
if((random 1) < 0.5 && count _enemyPlayers < 10 && count _enemyPlayers > 0) then {
...
private _playerPos = [[_pos select 0, _pos select 1, 500],_rad,_rad + 150,1,0,0,0] call findSafePos;
