...
#define ERR_ENEMY_BASE "You can't use defibrillator near enemy objects"
...
if (_success) then {
	...
	_target setVariable ["killOnBaseFlag", nil];
	//_target setVariable ["mutex_net_obj", nil, true];
