...
//@file Description: Deploy Heli

#define ERR_CANCELLED "Action Cancelled!"
#define ERR_IN_VEHICLE "Action Failed! You can't do this in a vehicle."
#define ERR_IN_ROCK "Action Failed! You cannot deploy a heli in a Object or rock."
#define ERR_IN_BUILDING "Action Failed! You cannot deploy a heli here."

#define ERR_NO_HELI "You don't have a heli to deploy."
...
switch (true) do {
	...
	case (MF_ITEMS_HELI call mf_inventory_count < 1): { _error = ERR_NO_HELI; };
};
