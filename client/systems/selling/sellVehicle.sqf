...
{
	#define CHOPSHOP_PRICE_RELATIONSHIP 2 //Was 2 BY_VLADOS
	...
	if (_vehicle getVariable ["A3W_notForSale", false]) exitWith
	{
		playSound "FD_CP_Not_Clear_F";
		["You cannot sell spawned vehicle.", "Error"] call  BIS_fnc_guiMessage;
	};
