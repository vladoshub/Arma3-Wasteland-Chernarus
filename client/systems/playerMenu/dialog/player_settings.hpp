...
class playerSettings {
	...
	class controls {
		...
		class nABookButton : w_RscButton2 {
			idc = -1;
			text = "INFO";
			colorBackground[] = {0,0,0,0.7};
			colorBackgroundActive[] = {0, 0.729, 1, 1};
			onButtonClick = "[] execVM 'addons\book\book.sqf'";
			x = 0.02; y = 0.32;
			w = 0.175; h = 0.033 * safezoneH;
		};
		...
		*/
		...
		class btnHelp : w_RscButton2 {
			idc = -1;
			text = "Help message On/Off";
			colorBackground[] = {0,0,0,0.7};
			colorBackgroundActive[] = {0, 0.729, 1, 1};
			onButtonClick = "[] execVM 'addons\helpMessage\button.sqf'";
			x = 0.02; y = 0.39;
			w = 0.3; h = 0.033 * safezoneH;
		};


		class btnYFilter : w_RscButton2 {
			idc = -1;
			text = "Yellow Filter ON/OFF";
			colorBackground[] = {0,0,0,0.7};
			colorBackgroundActive[] = {0, 0.729, 1, 1};
			onButtonClick = "[] execVM 'addons\yellowFilter\filter.sqf'";
			x = 0.02; y = 0.47;
			w = 0.3; h = 0.033 * safezoneH;
		};
