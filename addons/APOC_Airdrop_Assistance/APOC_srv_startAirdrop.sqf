...
switch (_type) do {
	...
	case "base": 	{_selectionArray = APOC_AA_Base_one};
...
_object = switch (_type) do {
	...
	case "base": {
		private _selectionClassObjs = _selectionClass select 0;
		private _selectionClassCargo = _selectionClass select 1;
		_objectSpawnPos = [(_spos select 0), (_spos select 1), (_spos select 2) - 5];
		_object = createVehicle [_selectionClassCargo, _objectSpawnPos, [], 0, "None"];
		...
		[_object, _selectionClassObjs] execVM "R3F_LOG\user_funct\auto_load_in_vehicle.sqf";
		_object
	};
	...
	case "base1": {
		...
		clearWeaponCargoGlobal _object;
		clearItemCargoGlobal _object;
		[_object, ["Land_Cargo_Tower_V1_F", ["Land_BagFence_Short_F", 4],["Land_BarGate_F", 2],["Land_Cargo_Patrol_V1_F", 2],["Land_HBarrierWall6_F", 4],["Land_Canal_WallSmall_10m_F", 10],["Land_LampShabby_F", 10], ["Land_RampConcreteHigh_F",2], ["Land_RampConcrete_F", 2],["Land_Crash_barrier_F",6],["I_GMG_01_F",2],["B_static_AA_F",1],["B_static_AT_F",1],["B_Quadbike_01_F",4]] ] execVM "R3F_LOG\user_funct\auto_load_in_vehicle.sqf";
		_object
	};
	...
	case "base2": {
		...
		clearWeaponCargoGlobal _object;
		clearItemCargoGlobal _object;
		[_object, [["Land_Cargo_Tower_V1_F",2],["Land_GH_Platform_F",10],["Land_BagFence_Short_F", 10],["Land_BarGate_F", 4],["Land_Cargo_Patrol_V1_F", 4],["Land_HBarrierWall6_F", 10],["Land_Canal_WallSmall_10m_F", 20],["Land_LampHalogen_F", 10], ["Land_RampConcreteHigh_F",4], ["Land_RampConcrete_F", 4],["Land_Crash_barrier_F",6],["B_GMG_01_F",2],["B_static_AA_F",2],["B_static_AT_F",2],["B_Quadbike_01_F",4],["C_Heli_light_01_digital_F",1]] ] execVM "R3F_LOG\user_funct\auto_load_in_vehicle.sqf";
		_object
	};
