class freestylesNuclearBlast
{
	class blast_fx
	{
		file = "addons\freestylesNuclearBlast\blastFx";
		class spikeSpawner {};
		class smokeSpikes {};
		class dustWave {};
		class soundFX {};
	...
	class blast_damage
	{
		file = "addons\freestylesNuclearBlast\blastDamage";
	...
	class misc_fncs
	{
		file = "addons\freestylesNuclearBlast\misc";
		class applyDamage {};
	...
	class init_fnc
	{
		file = "addons\freestylesNuclearBlast\init";
	...
	class ui_effects
	{
		file = "addons\freestylesNuclearBlast\uiEffects";
		class radiatedUI {};
	...
	class fire
	{
		file = "addons\freestylesNuclearBlast\fire";
		class createFire {};
		class fireSound {};
		class spawnFires {};
	};
