...
(isNull objectParent TARGET && !isNull objectParent HEALER) || (TARGET != cursorObject && {!(lineIntersectsObjs [ABDOMEN_ASL(HEALER), ABDOMEN_ASL(TARGET), TARGET, HEALER, false, 4] isEqualTo [])}))
