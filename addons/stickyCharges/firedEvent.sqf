...
if (_this select 1 == "Put") then
{
	...
	_dummy setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0)"]; //https://github.com/A3Wasteland/ArmA3_Wasteland.Altis/commit/8123c56921ffee905563dde6d29e546674dd2907
