...
class NH_KeyDialog
{
	...
	class controls
	{
		class baseFrame: IGUIBack_CodeLock
		{
			idc = 1800;
		...
		class buttonOne: RscButton_CodeLock
		{
			idc = 1600;
		...
		class buttonTwo: RscButton_CodeLock
		{
			idc = 1601;
		...
		class buttonThree: RscButton_CodeLock
		{
			idc = 1602;
		...
		class buttonFour: RscButton_CodeLock
		{
			idc = 1603;
		...
		class buttonFive: RscButton_CodeLock
		{
			idc = 1604;
		...
		class buttonSix: RscButton_CodeLock
		{
			idc = 1605;
		...
		class buttonSeven: RscButton_CodeLock
		{
			idc = 1606;
		...
		class buttonEight: RscButton_CodeLock
		{
			idc = 1607;
		...
		class buttonNine: RscButton_CodeLock
		{
			idc = 1608;
		...
		class buttonZero: RscButton_CodeLock
		{
			idc = 1609;
		...
		class buttonEnter: RscButton_CodeLock
		{
			idc = 1610;
		...
		class buttonLock: RscButton_CodeLock
		{
			idc = 1611;
		...
		class buttonChange: RscButton_CodeLock
		{
			idc = 1612;
		...
		class buttonClear: RscButton_CodeLock
		{
			idc = 1613;
		...
		class buttonClose: RscButton_CodeLock
		{
			idc = 1614;
		...
		class inputText: RscText_CodeLock
		{
			idc = 1000;
			align = "center";
		...
		class indicatorLocked: RscText_CodeLock
		{
			idc = 1001;
			align = "center";
			text = "";
