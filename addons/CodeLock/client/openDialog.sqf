...
private _keyPad = _this select 0;
//_keyPad setVariable ["building", _keyPad, true];
...
_btn1609 = (findDisplay _displayID) displayCtrl 1609;
	...
	["1"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1601 ctrlAddEventHandler ["ButtonClick",{

	["2"] execVM "addons\CodeLock\actions\addToText.sqf"
	...
	["3"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1603 ctrlAddEventHandler ["ButtonClick",{

	["4"] execVM "addons\CodeLock\actions\addToText.sqf"
	...
	["5"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1605 ctrlAddEventHandler ["ButtonClick",{

	["6"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1606 ctrlAddEventHandler ["ButtonClick",{

	["7"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1607 ctrlAddEventHandler ["ButtonClick",{

	["8"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1608 ctrlAddEventHandler ["ButtonClick",{

	["9"] execVM "addons\CodeLock\actions\addToText.sqf"
	    
	}];

	_btn1609 ctrlAddEventHandler ["ButtonClick",{

	["0"] execVM "addons\CodeLock\actions\addToText.sqf"
...
_btn1612 setVariable ["keyPad", _keyPad];
	...
	[_extracted] execVM "addons\CodeLock\actions\enterPressed.sqf";
	...
	[_extracted] execVM "addons\CodeLock\actions\lockDoors.sqf";
	...
	[_extracted] execVM "addons\CodeLock\actions\setCode.sqf";
