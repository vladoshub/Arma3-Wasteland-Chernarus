...
class TOParmaInfoD
{
	...
	{	
		class TAInfoBackground: RscText
		{
			...
			h = "34 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		...
		class TANewsBackground: RscText
		{
			...
			w = "30 * (((safezoneW / safezoneH) min 1.2) / 40)";
			h = "23.3 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
			//colorBackground[] = {0,0,0,0};
		};
		...
		{	
			...
			colorLinkActive[] = {0.69,0.75,0.5,1};
			x = "0.5 * (((safezoneW / safezoneH) min 1.2) / 40)";
			y = "14.7 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		...
		class TAInfoCloseButton: w_RscButton
		{
			...
			text = "Close and Agree to rules and terms / ESC";
			sizeEx = 0.04;
			x = "9 * (((safezoneW / safezoneH) min 1.2) / 40)";
			y = "33 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
