...
//Variables
//local
#define LOOT_SPAWN_INTERVAL 10*60   //Time (in sec.) to pass before an building spawns new loot (must also change in LSclientScan.sqf)  //was 5 BY VLADOS
...
[
	[1.0, 0.5, 0.5, 0.25, 0.25], // civil //BY VLADOS
	[1.0, 0.5, 0.5, 0.25, 0.25],  // military
	[1.0, 0.5, 0.5, 0.25, 0.25], // industrial
	[1.0, 0.5, 0.5, 0.25, 0.25]       // research
];
