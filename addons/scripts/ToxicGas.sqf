...
while {true} do {
	...
	//by vlados 
	waitUntil{
		((nearestObject [getPosATL player, "SmokeShellGreen"]) distance player < 10) and (getPosATL (nearestObject [getPosATL player, "SmokeShellGreen"]) select 2 < 0.5) and ((nearestObject [getPosATL player, "land_bunker_garage"]) distance player > 25) and ((nearestObject [getPosATL player, "Land_BagBunker_Large_F"]) distance player > 20) and ((nearestObject [getPosATL player, "FlagChecked_F"]) distance player > 40) and ((nearestObject [getPosATL player, "Land_Bunker_01_big_F"]) distance player > 20) and ((nearestObject [getPosATL player, "WarfareBDepot"]) distance player > 20) and ((nearestObject [getPosATL player, "Land_Cargo_Tower_V4_F"]) distance player > 20) and ((nearestObject [getPosATL player, "Land_PierConcrete_01_16m_F"]) distance player > 30) and ((nearestObject [getPosATL player, "Land_Pier_Box_F"]) distance player > 50) and ((nearestObject [getPosATL player, "Land_Cargo_Patrol_V1_F"]) distance player > 7)
		or
		((nearestObject [getPosATL player, "G_40mm_SmokeGreen"]) distance player < 10) and (getPosATL (nearestObject [getPosATL player, "G_40mm_SmokeGreen"]) select 2 < 0.5) and ((nearestObject [getPosATL player, "land_bunker_garage"]) distance player > 25) and ((nearestObject [getPosATL player, "Land_BagBunker_Large_F"]) distance player > 20) and ((nearestObject [getPosATL player, "FlagChecked_F"]) distance player > 40) and ((nearestObject [getPosATL player, "Land_Bunker_01_big_F"]) distance player > 20) and ((nearestObject [getPosATL player, "WarfareBDepot"]) distance player > 20) and ((nearestObject [getPosATL player, "Land_Cargo_Tower_V4_F"]) distance player > 20) and ((nearestObject [getPosATL player, "Land_PierConcrete_01_16m_F"]) distance player > 30) and ((nearestObject [getPosATL player, "Land_Pier_Box_F"]) distance player > 50) and ((nearestObject [getPosATL player, "Land_Cargo_Patrol_V1_F"]) distance player > 7)
	};

	if (((((headgear player) in _gasMask) || (goggles player in _gasMaskGog)) && !((typeOf (vehicle player)) in _AAPositions)) || ((typeOf vehicle player) in _exemptVehicles) || (typeOf vehicle player) isKindOf "Tank_F") then {
		"dynamicBlur" ppEffectEnable true; // enables ppeffect
