...
class CHVD_dialog
{
	...
	class controls
	{
		...
		class CHVD_rscSmartModeCheckbox: CHVD_rscCheckbox
		{
			idc = 2810;
			onCheckedChanged = "[_this select 1, 'CHVD_autoMode', 1909, 1099, 'CHVD_desiredFPS', 1299, 1929, 1919, 1199] call CHVD_fnc_onCheckedChangedSmart";
		...
		class CHVD_rscDesiredFPSSlider: CHVD_rscXSliderH
		{
			idc = 1909;
			type = 43;
			onSliderPosChanged = "['CHVD_desiredFPS', _this select 0, _this select 1, 1099] call CHVD_fnc_onSliderChangeSmart";
		...
		class CHVD_rscDesiredFPSText: CHVD_rscTextRight
		{
			idc = 1079;

			text = "Min FPS:"; //--- ToDo: Localize;
			x = 7.5 * GUI_GRID_W + GUI_GRID_X;
			y = 22.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 6.5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class CHVD_rscSmartViewText: CHVD_rscTextRight
		{
			idc = 1059;

			text = "Auto view distance"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
			y = 20.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 12.5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class CHVD_rscDesiredFPS: CHVD_rscEdit
		{
			idc = 1099;
			onKeyDown = "['CHVD_desiredFPS', 1909, _this select 0] call CHVD_fnc_onEBinputSmart";
			maxChars = 5;
		...
		class CHVD_rscMinViewDistanceText: CHVD_rscTextRight
		{
			idc = 1089;

			text = "Min View Distance"; //--- ToDo: Localize;
			x = 7.5 * GUI_GRID_W + GUI_GRID_X;
		...
		class CHVD_rscMinViewDistanceSlider: CHVD_rscXSliderH
		{
			idc = 1919;
			type = 43;
			onSliderPosChanged = "['CHVD_MinViewDistance', _this select 0, _this select 1, 1199] call CHVD_fnc_onSliderChangeSmart";
		...
		class CHVD_rscMinViewDistance: CHVD_rscEdit
		{
			idc = 1199;
			onKeyDown = "['CHVD_MinViewDistance', 1919, _this select 0] call CHVD_fnc_onEBinputSmart";
			maxChars = 5;
		...
		class CHVD_rscMinViewDistanceObjText: CHVD_rscTextRight
		{
			idc = 1097;

			text = "Min View Distance Object"; //--- ToDo: Localize;
			x = 7.5 * GUI_GRID_W + GUI_GRID_X;
		...
		class CHVD_rscMinViewDistanceObjSlider: CHVD_rscXSliderH
		{
			idc = 1929;
			type = 43;
			onSliderPosChanged = "['CHVD_MinViewDistanceObj', _this select 0, _this select 1, 1299] call CHVD_fnc_onSliderChangeSmart";
		...
		class CHVD_rscMinViewDistanceObj: CHVD_rscEdit
		{
			idc = 1299;
			onKeyDown = "['CHVD_MinViewDistanceObj', 1929, _this select 0] call CHVD_fnc_onEBinputSmart";
			maxChars = 5;
