...
0 spawn
{
	...
	if (isNil "CHVD_maxView") then { CHVD_maxView = 4500 }; //12000
	if (isNil "CHVD_maxObj") then { CHVD_maxObj = 4500};

	CHVD_footSyncObj = profileNamespace getVariable ["CHVD_footSyncObj", true];
	CHVD_carSyncObj = profileNamespace getVariable ["CHVD_carSyncObj", true];
	CHVD_airSyncObj = profileNamespace getVariable ["CHVD_airSyncObj", true];
	...
	*/
	...
	CHVD_foot = (profileNamespace getVariable ["CHVD_foot", 3000]) min CHVD_maxView max 200;
	CHVD_car = (profileNamespace getVariable ["CHVD_car", 3000]) min CHVD_maxView max 200;
	CHVD_air = (profileNamespace getVariable ["CHVD_air", 3000]) min CHVD_maxView max 200;

	CHVD_footObj = (profileNamespace getVariable ["CHVD_footObj", 3000]) min CHVD_maxObj max 0;
	CHVD_carObj = (profileNamespace getVariable ["CHVD_carObj", 3000]) min CHVD_maxObj max 0;
	CHVD_airObj = (profileNamespace getVariable ["CHVD_airObj",3000]) min CHVD_maxObj max 0;

	

	CHVD_autoMode = profileNamespace getVariable ["CHVD_autoMode", false];
	CHVD_desiredFPS = profileNamespace getVariable ["CHVD_desiredFPS", 60];
	
	CHVD_MinViewDistance = profileNamespace getVariable ["CHVD_MinViewDistance", 1600];
	CHVD_MinViewDistanceObj = profileNamespace getVariable ["CHVD_MinViewDistanceObj", 1600];


	if (CHVD_allowTerrain) then
	{
		CHVD_footTerrain = (profileNamespace getVariable ["CHVD_footTerrain", 48]) min 48 max 3.125; //getTerrainGrid //50
		CHVD_carTerrain = (profileNamespace getVariable ["CHVD_carTerrain", 48]) min 48 max 3.125; //getTerrainGrid //50
		CHVD_airTerrain = (profileNamespace getVariable ["CHVD_airTerrain", 48]) min 48 max 3.125; //getTerrainGrid //50
