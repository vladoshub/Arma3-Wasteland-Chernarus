...
{
	ctrlSetText _x;
} forEach [[1006, str round CHVD_foot],[1007, str round CHVD_footObj],[1013, str round CHVD_car],[1014, str round CHVD_carObj],[1017, str round CHVD_air],[1018, str round CHVD_airObj],[1099, str round CHVD_desiredFPS], [1199, str round CHVD_MinViewDistance], [1299, str round CHVD_MinViewDistanceObj]];
...
{
	sliderSetRange [_x select 0, 10, _x select 2];
	sliderSetSpeed [_x select 0, 500, 500];
	sliderSetPosition [_x select 0, _x select 1];
} forEach [[1909,CHVD_desiredFPS,240]];
...

{
	...
	sliderSetSpeed [_x select 0, 500, 500];
	sliderSetPosition [_x select 0, _x select 1];
} forEach [[1919,CHVD_MinViewDistance, 4500], [1929,CHVD_MinViewDistanceObj, 4500]];
...

{
	...
	_textStandard = if (isLocalized "STR_chvd_standard") then {localize "STR_chvd_standard"} else {"Standart"};
	...
	_textUltra = if (isLocalized "STR_chvd_veryHigh") then {localize "STR_chvd_veryHigh"} else {"Ultra"};
...
if (CHVD_autoMode) then {
	ctrlEnable [1909, true];
	ctrlEnable [1099, true];

	ctrlEnable [1299, true];
	ctrlEnable [1929, true];
	ctrlEnable [1919, true];
	ctrlEnable [1199, true];
} else {	
	ctrlEnable [1909, false];
	ctrlEnable [1099, false];

	ctrlEnable [1299, false];
	ctrlEnable [1929, false];
	ctrlEnable [1919, false];
	ctrlEnable [1199, false];
};
