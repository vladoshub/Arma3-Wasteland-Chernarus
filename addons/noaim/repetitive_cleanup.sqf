...
GVAR(deleteClassesConfig) = [
	...
	[M* 5*60, ["NonSteerable_Parachute_F","Steerable_Parachute_F","Land_FoodSack_01_full_white_idap_F","Land_CanisterFuel_F", "Land_Mil_WallBig_corner_battered_F", "Land_CanisterOil_F","Chemlight_blue","Chemlight_green","Chemlight_red","Chemlight_yellow","WeaponHolder","GroundWeaponHolder","WeaponHolderSimulated","Ruins","#destructioneffects","CraterLong_small","CraterLong","SmokeShellBlue","SmokeShellGreen","SmokeShellOrange","SmokeShellRed","SmokeShell","SmokeShellYellow", "Land_Sack_F", "Land_Teapot_EP1"]],
...

    {
    	_object = _x;
		{
	    	...
	    	if(_timeToDelete>0) then {
		    	{
					if( ((typeof _object == _x) || {(_object isKindOf _x)}) && ((_object getVariable ["forDeleteObject", true])) ) then {
