...
{
	//_uav disableTIEquipment true; //BY_VLADOS
};

//SET max height for drone
//if ({_uav isKindOf _x} count ["B_UAV_01_F", "O_UAV_01_F", "I_UAV_01_F", "C_IDAP_UAV_01_F"] > 0) then
//{
//	//_uav disableTIEquipment true; //DISABLE THERMAL
//	_uav flyInHeight [50, true];
//};

//SET max height for drone
//if ({_uav isKindOf _x} count ["I_E_UAV_06_medical_F","I_E_UAV_06_F","B_UAV_06_F","B_UAV_06_medical_F","C_IDAP_UAV_06_antimine_F","C_IDAP_UAV_06_F","C_IDAP_UAV_06_medical_F","C_UAV_06_F","C_UAV_06_medical_F","I_UAV_06_F","I_UAV_06_medical_F","O_UAV_06_F","O_UAV_06_medical_F"] > 0) then
//{
//	//_uav disableTIEquipment true; //DISABLE THERMAL
//	_uav flyInHeight [100, true];
//};

//SET max height for drone
//if ({_uav isKindOf _x} count ["I_UAV_06_F","O_UAV_06_F","B_UAV_06_F"] > 0) then
//{
//	//_uav disableTIEquipment true; //DISABLE THERMAL
//	_uav flyInHeight [100, true];
//};
...
//[_uav] execVM "addons\outOfBounds\outOfBoundsRemoteStore.sqf"; //BY_VLADOS
