...
{
	if (random 1 < 0.1) then // 10% chance of box spawning at each town //BY VLADOS
	{
		_pos = getMarkerPos (_x select 0);
		_boxClass = selectRandom _boxList;
