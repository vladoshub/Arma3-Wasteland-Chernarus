...
switch (_boxType) do {
	...
	case "mission_drone_box": {
		_boxItems = [
			["bac", "B_UAV_06_backpack_F", RANDOM_BETWEEN(3,6)],
			["bac", "I_UAV_06_backpack_F", RANDOM_BETWEEN(3,6)],
			["bac", "O_UAV_06_backpack_F", RANDOM_BETWEEN(3,6)],
			["mag", "DemoCharge_Remote_Mag", RANDOM_BETWEEN(3,6)],
			["itm", "B_UavTerminal", 1],
			["itm", "O_UavTerminal", 1],
			["itm", "I_UavTerminal", 1]
		];
	};
	case "mission_spectrum_weapon": {
		_boxItems = [
			["wep", "hgun_esd_01_F", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_antenna_02_f", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_antenna_03_f", RANDOM_BETWEEN(1,3)]
		];
	};
