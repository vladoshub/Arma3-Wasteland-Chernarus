...
createCustomGroupAA = [_path, "createUnits\customGroupAA.sqf"] call mf_compile;
createCustomGroupTown = [_path, "createUnits\customGroupTown.sqf"] call mf_compile;
...
createBlock = [_path, "createBlock.sqf"] call mf_compile;
createRandomSoldierNew = [_path, "createUnits\createRandomSoldierNew.sqf"] call mf_compile;
...
mission_VehicleCaptureLight = "server\missions\mainMissions\mission_VehicleCaptureLight.sqf" call mf_compile;
mission_UltraVehicleCapture = "server\missions\ultraMissions\mission_UltraVehicleCapture.sqf" call mf_compile;
mission_JetNukeCapture = "server\missions\ultraMissions\mission_JetNukeCapture.sqf" call mf_compile;
mission_BigBoatCapture = "server\missions\ultraMissions\mission_BigBoatCapture.sqf" call mf_compile;
mission_MechCapture = "server\missions\ultraMissions\mission_MechCapture.sqf" call mf_compile;
mission_ObjectCapture = "server\missions\ultraMissions\mission_ObjectCapture.sqf" call mf_compile;
...
soundBroadcast = [_path, "soundBroadcast.sqf"] call mf_compile;
...
serverAiDiedMoneyDrop = [_path, "serverAiDiedMoneyDrop.sqf"] call mf_compile;
...
staticJetCreation = [_path, "staticJetCreation.sqf"] call mf_compile;
staticTankCreation = [_path, "staticTankCreation.sqf"] call mf_compile;
