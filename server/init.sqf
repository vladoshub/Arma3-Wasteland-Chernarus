...
if (isServer) then
{
	...
	[] execVM "addons\CodeLock\doorConfig.sqf";  //before load objects!
	...
	addMissionEventHandler ["HandleDisconnect",
	{
		...
		{
			//https://github.com/A3Wasteland/ArmA3_Wasteland.Altis/commit/c547ad138d4dcae6493740fc82ecc0ba4ed13605
			...
			//https://github.com/A3Wasteland/ArmA3_Wasteland.Altis/commit/dc41623f154d6c5be683374784aba201a0628e60
			if (["A3W_playerSaving"] call isConfigOn) then
			{
...
if (isServer) then
{
	...
	//execVM "server\functions\removeObjects.sqf"; // BY VLADOS
	//execVM "server\functions\removeMarkers.sqf"; // BY VLADOS
...
if (isServer) then
{
	...
	[
		...
		"A3W_bountyLifetime",
		"A3W_atmBounties",
		"A3W_timeMultiplierDay",
		"A3W_timeMultiplierNight",
		"A3W_mineSaving",
		"A3W_mineLifetime"
...
[] execVM "server\functions\serverTimeSync.sqf"; //BY_VLADOS
...
if (["A3W_serverSpawning"] call isConfigOn) then
{
	...
	if (["A3W_heliSpawning"] call isConfigOn) then
	{
		...
		call compile preprocessFileLineNumbers "server\functions\staticJetSpawning.sqf"; //BY_VLADOS
		call compile preprocessFileLineNumbers "server\functions\staticTankSpawning.sqf";//BY_VLADOS
	};
...
[] execVM "addons\aiTown\spawnChecker.sqf";
[] execVM "addons\ground_spawner\spawner.sqf";
[] execVM "addons\ground_spawner\spawnerMoney.sqf";
[] execVM "addons\ground_spawner\spawnerAdditional.sqf";

if(isServer) then {
	_need serverCommand "#unlock";
};