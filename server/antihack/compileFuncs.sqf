...
//{
	...
	[
		...
		["KICK_by_idle", _assignChecksum, "server\functions\idleKick\serverSideidleKick.sqf"], 
		["global_say_3d", _assignChecksum, "server\functions\say\say.sqf"], 
		["CRAM_unit", _assignChecksum, "addons\cram\init.sqf"],
		["User_monitor", _assignChecksum, "addons\userMonitor\show.sqf"],
		["hard_vehicle_message", _assignChecksum, "addons\userMonitor\warningVehicleMessage.sqf"],
		["freestylesNuclearBlastInvoke", _assignChecksum, "addons\freestylesNuclearBlast\server\invokeServer.sqf"]
	];
