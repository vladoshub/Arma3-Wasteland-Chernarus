...
_soldier addHeadgear (selectRandom (_loadout select 0));
_soldier forceAddUniform (selectRandom (_loadout select 1));
_soldier addVest (selectRandom (_loadout select 2));
...
_soldier addPrimaryWeaponItem (selectRandom _scope);
