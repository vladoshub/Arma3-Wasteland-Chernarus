...
_setupVars =
{
	...
	[
		// Easy
		[
			"LIGHT: Small Money Shipment", // Marker text
			150000, // Money
			[
				[ // NATO convoy
		...
		// Medium
		[
			"MIDDLE: Medium Money Shipment", // Marker text
			250000, // Money
			[
				[ // NATO convoy
		...
		// Hard
		[
			"HARD: Large Money Shipment", // Marker text
			500000, // Money
			[
				[ // NATO convoy
				...
				[ // CSAT convoy
					...
					["O_MBT_02_cannon_F", "O_MBT_02_cannon_F"], // Veh 2
		...
		// Extreme
		[
			"HARD: Heavy Money Shipment", // Marker text
			1000000, // Money
			[
				[ // NATO convoy
