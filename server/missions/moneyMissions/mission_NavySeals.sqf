...
private ["_nbUnits", "_box1", "_box2", "_loadout", "_net1", "_buildingRadius","_putOnRoof","_fillEvenly","_drop_item", "_cash"];

_setupVars =
{
	_missionType = "MIDDLE: Navy Seals";
...
_setupObjects =
{
	...
	sideObj setVariable ["allowDamage", true, true];
