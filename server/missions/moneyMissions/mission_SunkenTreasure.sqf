...
_setupVars =
{
	_missionType = "HARD: Sunken Treasure";
...
_setupObjects =
{
	...
	_missionHintText = format ["A treasure containing 1000000$ and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", moneyMissionColor];
};
