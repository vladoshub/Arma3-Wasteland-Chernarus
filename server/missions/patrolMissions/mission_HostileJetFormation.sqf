...
_setupVars =
{
	_missionType = "MIDDLE: Hostile Jets Formation";
...
_setupObjects =
{
	...
	_convoyVeh = selectRandom _planeChoices;
	...
	_missionHintText = format ["A formation of Jets containing two <t color='%3'>%1</t> are patrolling the island. Destroy them and recover their cargo!", _vehicleName, _vehicleName2, patrolMissionColor];
