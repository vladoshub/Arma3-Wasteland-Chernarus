...
_setupVars = {
	_missionType = "MIDDLE: Cobra maneuver!";
	_locationsArray = nil;
};
...
_setupObjects = {
	...
	_missionHintText = format ["OH Damn <t color='%4'>%1</t> has been spotted! <br/>Bring it down! NOW!! or it will kill you, oh by the way take its cargo!", _vehicleName, patrolMissionColor];
