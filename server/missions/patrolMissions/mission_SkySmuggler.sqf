...
_setupVars =
{
	_missionType = "HARD: Sky Smuggler";
	_locationsArray = nil; // locations are generated on the fly from towns
};

_setupObjects =
{
	_missionPos = markerPos ((selectRandom (call cityList)) select 0);
	...
	_missionHintText = format ["A Smuggler is being escorted in a <t color='%3'>%1</t> by two Experimental <t color='%3'>%2</t> around the island. Destroy them and recover their cargo!", _vehicleName, _vehicleName2, patrolMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "The sky is clear again, the Smuggler and Escort were taken out! Ammo crates has fallen near the wreck.";
};
