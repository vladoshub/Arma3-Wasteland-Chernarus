...
_setupVars =
{
	_missionType = "MIDDLE: Hostile Xian";
...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> is patrolling the island. Intercept the pilot and recover his high value cargo! But be careful, he will target vehicles!.", _vehicleName, patrolMissionColor];
