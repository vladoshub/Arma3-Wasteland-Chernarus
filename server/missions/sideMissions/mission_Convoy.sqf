...
_setupVars =
{
	_missionType = "LIGHT: Armed Convoy";
...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> transporting 2 weapon crates is being escorted by armed vehicles. Stop them!", _vehicleName, sideMissionColor];
