...
_setupObjects =
{
	...
	_convoyVeh = selectRandom _vehChoices;
	...
	_missionHintText = format ["A Seal Team with two <t color='%3'>%1</t> have been spotted patrolling the coasts.<br/>Intercept them and recover their cargo!", _vehicleName, sideMissionColor];
