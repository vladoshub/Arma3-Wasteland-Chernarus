...
_setupObjects =
{
	...
	_smugglerVeh = selectRandom ["B_MRAP_01_hmg_F","O_MRAP_02_hmg_F","I_MRAP_03_hmg_F"]; 
	...
	_currBox1 = selectRandom _boxes1;
	_randomBox = selectRandom ["mission_Launchers1","mission_Weapon1","mission_Snipers1"];
	...
	_currBox2 = selectRandom _boxes2;
	...
	_missionHintText = format ["A group of people captured the point. Stop them and claim the rewards .", sideMissionColor];
};
...
_successExec =
{
	...
	_cashamountrandomizera = [2500,5000,10000,15000];
	_cashpilerandomizera = [3,5];
		
	//_casha = selectRandom _cashrandomizera;
	_cashamounta = selectRandom _cashamountrandomizera;
	_cashpilea = selectRandom _cashpilerandomizera;
	...
	_cashamountrandomizerb = [2500,5000,10000,15000];
	_cashpilerandomizerb = [3,5];
		
	_cashb = selectRandom _cashrandomizerb;
	_cashamountb = selectRandom _cashamountrandomizerb;
	_cashpileb = selectRandom _cashpilerandomizerb;
	...
	_successHintMessage = format ["The point is cleared,take gear now!"];
};
