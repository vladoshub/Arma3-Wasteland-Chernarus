...
private ["_nbUnits", "_box1", "_box2", "_box3", "_box4", "_drop_item", "_roadBlock", "_objects"];

_setupVars =
{
	_missionType = "HARD: Road Block";
...
_successExec =
{
	...
	switch (_numBoxes) do // because apparently a for _i loop doesnt work with missions... bad coding? pfft.
	{
		case 1: {
			...
			_randomBox = selectRandom ["mission_Weapon1","mission_Launchers1","mission_Snipers1"];
			[_box1, _randomBox] call fn_refillbox;
		};
		case 2: {
			_box1 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box1 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon2","mission_Launchers2","mission_Snipers2"];
			[_box1, _randomBox] call fn_refillbox;
		...
		case 3: {
			_box1 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box1 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon3","mission_Launchers3","mission_Snipers3"];
			[_box1, _randomBox] call fn_refillbox;
			_box2 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box2 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon3","mission_Launchers3","mission_Snipers3"];
		...
		case 4: {
			_box1 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box1 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon_camo","mission_LMGs1","mission_Snipers4"];
			[_box1, _randomBox] call fn_refillbox;
			_box2 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box2 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon_green","mission_LMGs1","mission_Snipers4"];
			[_box2, _randomBox] call fn_refillbox;
			_box3 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box3 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon_tropic","mission_Launchers1","mission_DLC_apex"];
			[_box3, _randomBox] call fn_refillbox;
			_box4 = createVehicle [(selectRandom _crateBoxes), _missionPos, [], 15, "None"];
			_box4 setDir random 360;
			_randomBox = selectRandom ["mission_Weapon_sand","mission_Launchers1","mission_DLC_apex"];
