...
private ["_vehicle", "_vehicleName", "_vehDeterminer", "_variant", "_veh1Object", "_veh2Object"];
...
_setupObjects =
{
	...
	_nukeJetVeh = selectRandom _vehChoices;

	_veh1 = _nukeJetVeh select 0;
	_veh2 = _nukeJetVeh select 1;
	...
	_spawn1 = [((_missionPos select 0) + 30), (_missionPos select 1), (_missionPos select 2)];
	_spawn2 = [(_missionPos select 0), ((_missionPos select 1) + 30), (_missionPos select 2)];
