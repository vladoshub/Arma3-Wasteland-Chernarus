...
private ["_nbUnits", "_drop_item", "_block", "_objects", "_veh1Object", "_veh2Object", "_veh3Object", "_vehicleClass", "_createVehicle", "_objFlag"];

_setupVars =
{
	_missionType = "ULTIMATE: Capture the Base Flag (spawn)";	
...
_setupObjects =
{
	...
	[
		...
		["I_APC_Wheeled_03_cannon_F", "O_APC_Tracked_02_AA_F"],
		["O_MBT_04_command_F", "B_APC_Tracked_01_AA_F"]
	];
	...
	_objFlag = createVehicle ["FlagChecked_F", _missionPos, [], 0, "NONE"];
	_objFlag allowDamage false;
	_objFlag setVariable ["allowDamage", false, true];
	_objFlag setVariable ["R3F_LOG_disabled", true, true];
	...
	*/
	...
	_missionHintText = format ["The enemies created a base and hid flag there! Take them!", ultraMissionColor];
};
...
_failedExec =
{
	...
	if (alive _objFlag) then {
		deleteVehicle _objFlag;
	};
...
_successExec =
{
	...
	_objFlag allowDamage true;
	_objFlag setVariable ["allowDamage", true, true];
	_objFlag setVariable ["R3F_LOG_disabled", false, true];
	[_objFlag, 1] call A3W_fnc_setLockState;
	...
	_successHintMessage = "The Flag has been capture!";
