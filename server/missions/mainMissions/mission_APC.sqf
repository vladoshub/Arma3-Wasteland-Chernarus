...
_setupVars =
{
	...
	{
		case ({_vehicleClassTmp isKindOf _x} count ["B_APC_Tracked_01_AA_F", "O_APC_Tracked_02_AA_F"] > 0): { "MIDDLE: Anti Aircraft Vehicle" };
		case (_vehicleClassTmp isKindOf "Tank_F"):                                                          { "MIDDLE: Infantry Fighting Vehicle" };
		case (_vehicleClassTmp isKindOf "AFV_Wheeled_01_base_F"):                                           { "MIDDLE: Armored Fighting Vehicle" };
		default                                                                                             { "MIDDLE: Armored Personnel Carrier" };
	};
