...
_setupObjects = {
	...
	_missionHintText = format ["<br/>Enemy raided the graveyard. Seek and Destroy them all. Let them enter the grave.", extraMissionColor];
};
...
_successExec = {
	// Mission completed
	_randomBox = selectRandom ["mission_Snipers4","mission_Snipers2"];
