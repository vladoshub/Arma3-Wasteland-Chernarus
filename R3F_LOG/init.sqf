...
#include "R3F_LOG_ENABLE.h"
	...
	if (isServer) then
	{
		...
		Create_Vehicle_R3F_LOG = compile preprocessFileLineNumbers "R3F_LOG\usine_creation\create_vehicle.sqf";
	...
	if !(isDedicated) then
	{
		...
		R3F_LOG_FNCT_objet_deplacer_with_check = compile preprocessFile "R3F_LOG\objet_deplacable\deplacerWithCheck.sqf";
		R3F_LOG_FNCT_objet_deplacer_with_check_enemy = compile preprocessFile "R3F_LOG\objet_deplacable\deplacerWithCheckEnemy.sqf";

		//R3F_LOG_FNCT_objet_lock = compile preprocessFile "R3F_LOG\lock\objectLockStateMachine.sqf";
		//R3F_LOG_FNCT_objet_unlock = compile preprocessFile "R3F_LOG\lock\objectLockStateMachine.sqf";
		...
		//R3F_LOG_FNCT_remorqueur_attach_direct = compile preprocessFile "R3F_LOG\remorqueur\attach_direct.sqf";
